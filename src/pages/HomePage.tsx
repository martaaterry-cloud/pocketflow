...
export function HomePage({
  ...
  // Carrusel activo: 0 = Banco, 1 = Efectivo, 2 = Total
  ...
  // Manejo de scroll en carrusel
  const handleScroll = () => {
    const el = carouselViewportRef.current
    if (!el) return
    const width = el.clientWidth
    if (width > 0) {
      const newIndex = Math.round(el.scrollLeft / width) as 0 | 1 | 2
      if (newIndex !== activeSlide && (newIndex === 0 || newIndex === 1 || newIndex === 2)) {
  ...
  return (
    <main className="page">
      ...
      {/* Selector de pestañas / Indicador del carrusel */}
      <nav className="home-segmented-nav" aria-label="Seleccionar vista financiera">
        <button
          type="button"
          className={`home-segmented-tab ${activeSlide === 0 ? 'active' : ''}`}
        ...
        <button
          type="button"
          className={`home-segmented-tab ${activeSlide === 1 ? 'active' : ''}`}
        ...
        <button
          type="button"
          className={`home-segmented-tab ${activeSlide === 2 ? 'active' : ''}`}
      ...
      {/* Viewport del carrusel con scroll-snap */}
      <div
      ...
      >
        {/* ==================================================================
            SLIDE 0: BANCO (Home Tradicional)
            ================================================================== */}
        <section className="home-carousel-slide" aria-label="Vista Banco">
          <section
        ...
        {/* ==================================================================
            SLIDE 1: EFECTIVO (Home Específica de Efectivo)
            ================================================================== */}
        <section className="home-carousel-slide" aria-label="Vista Efectivo">
        ...
        {/* ==================================================================
            SLIDE 2: TOTAL (Visión Global de Liquidez y Consumo)
            ================================================================== */}
        <section className="home-carousel-slide" aria-label="Vista Total">
      ...
      {/* Indicadores de puntos inferiores del carrusel */}
      <div className="home-carousel-dots" aria-hidden="true">
        <button
          type="button"
          className={`home-carousel-dot ${activeSlide === 0 ? 'active' : ''}`}
          onClick={() => scrollToSlide(0)}
          aria-label="Ir a vista Banco"
        />
        <button
          type="button"
          className={`home-carousel-dot ${activeSlide === 1 ? 'active' : ''}`}
          onClick={() => scrollToSlide(1)}
          aria-label="Ir a vista Efectivo"
        />
        <button
          type="button"
          className={`home-carousel-dot ${activeSlide === 2 ? 'active' : ''}`}
          onClick={() => scrollToSlide(2)}
          aria-label="Ir a vista Total"
        />
      </div>
